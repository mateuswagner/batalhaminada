...
int main (void){
    ...
    wchar_t tabuleironovo[16][16]; // caracter unicode expandido
    time_t t;
    wchar_t n = 0x1F4A5;
    srand(time(NULL));
    setlocale(LC_CTYPE, "");
    ...
    if (retorno == 1 || retorno == 3){
        for (i=0; i<16; i++){                         //for para criação do tabuleiro
            for ( j=0; j<16; j++){
                tabuleiro1[i][j] = '~';
        ...
        for(i=1; i<=5; i++){                           // for para implementação dos barcos no tabuleiro
            ...
            do{
                b=0;
                li = 1 + rand()%15;                      //criação de locais aleatórios para barcos
                c  = 1 + rand()%15;
        ...
        while (cont < 12){
            ...
            li = 1 + rand()%15;                      //criação de locais aleatórios para bombas
            c  =  1 + rand()%15;
            if((li!=0) || (c!=0)){
...
//----------------------Entrada do usuario------------------               
        ...
        while(bomba < 3 && barco < 15){
            ...
            else if ((col=='y') || (col=='Y')) j=11; //printf(" ");}
            else if ((col=='z') || (col=='Z')) j=12; //printf(" ");}
            else if ((col=='r') || (col=='R')) j=13; //printf(" ");}
            else if ((col=='s') || (col=='S')) j=14; //printf(" ");}
            else{
                j = 20; 
            }
            controle = 0;
