...
int main (void){
    ...
    wchar_t tabuleironovo[14][14]; // caracter unicode expandido
    time_t t;
    wchar_t n = 0x1F4A5;
    srand(time(NULL));
    setlocale(LC_CTYPE, "");
    ...
    if (retorno == 1 || retorno == 3){
        for (i=0; i<14; i++){                         //for para criação do tabuleiro
            for ( j=0; j<14; j++){
                tabuleiro1[i][j] = '~';
        ...
        for(i=1; i<=5; i++){                           // for para implementação dos barcos no tabuleiro
            ...
            do{
                b=0;
                li = 1 + rand()%13;                      //criação de locais aleatórios para barcos
                c  = 1 + rand()%13;
        ...
        while (cont < 8){
            ...
            li = 1 + rand()%13;                      //criação de locais aleatórios para bombas
            c  =  1 + rand()%13;
            if((li!=0) || (c!=0)){
